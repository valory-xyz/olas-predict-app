...
export const SERVICE_REGISTRY_ADDRESS: Address = '0x9338b5153AE39BB89f50468E608eD9d764B755fD';

export const SERVICE_REGISTRY_ABI: Abi = [
  {
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'address', name: 'multisig', type: 'address' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'drainer', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'amount', type: 'uint256' },
    ],
    name: 'Drain',
    type: 'event',
  ...
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: 'address', name: 'drainer', type: 'address' }],
    name: 'DrainerUpdated',
    type: 'event',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: 'operator', type: 'address' },
      { indexed: true, internalType: 'uint256', name: 'serviceId', type: 'uint256' },
      { indexed: true, internalType: 'address', name: 'agentInstance', type: 'address' },
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: 'serviceOwner', type: 'address' },
      { internalType: 'uint256', name: 'serviceId', type: 'uint256' },
      { internalType: 'address', name: 'multisigImplementation', type: 'address' },
